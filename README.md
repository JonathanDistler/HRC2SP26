...
Finally, I "cd'ed" into the setup.py file and changed the entropy points to reflect the addition of the waypoints. 
...
In the same terminal, run the following to initialize a previously built map of the room:
...
To specify a location to navigate toward, run one of the following commands.
